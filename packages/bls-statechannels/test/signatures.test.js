...
const { randomSigner, signState, getChannelId, hashState, getFixedPart, getVariablePart, messageToHash } = require('../src/signatures')
...
describe('signatures', () => {
  describe('signState', () => {
    it('signs a state and creates a checkpoint', async () => {
